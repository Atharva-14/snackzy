      ...
      <div className="flex flex-col items-end">
        <div className="pr-4 pb-2.5">
          ...
          <Link
            ...
            className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-200 bg-[linear-gradient(110deg,#edf5ff,45%,#d0e7ff,55%,#edf5ff)]
 bg-[length:200%_100%] px-6 font-medium text-slate-800 transition-colors focus:outline-none"
          >
            Join as a Seller
          </Link>
        </div>
